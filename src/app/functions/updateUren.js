...
exports.main = async (context = {}) => {
  try {
    const { companyId, regId, uren, werktype, omschrijving, datum } =
      context.parameters || {};
    ...
    await api(`/crm/v3/objects/${types.uren}/${regId}`, 'PATCH', {
      properties: {
        uren: aantal,
    ...
    if (kaartIds.length) {
      ...
      const nieuwVerbruikt = kaart.verbruikt - oudeUren + aantal;
